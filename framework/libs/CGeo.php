...
class CGeo{
    ...
    static $x_pi = 52.35987755983; //3.14159265358979324 * 3000.0 / 180.0
    

    //WGS-84 to GCJ-02
    static function gcj_encrypt($wgsLat, $wgsLon)
    {
    ...
    //GCJ-02 to WGS-84
    static function gcj_decrypt($gcjLat, $gcjLon)
    {
    ...
    static function gcj_decrypt_exact($gcjLat, $gcjLon)
    {
        $initDelta = 0.01;
    ...
    //GCJ-02 to BD-09
    static function bd_encrypt($gcjLat, $gcjLon)
    {
        $x = $gcjLon; $y = $gcjLat;  
    ...
    //BD-09 to GCJ-02
    static function bd_decrypt($bdLat, $bdLon)
    {
    ...
    static function mercator_encrypt($wgsLat, $wgsLon)
    {
    ...
    // $mercatorLat -> y $mercatorLon -> x
    static function mercator_decrypt($mercatorLat, $mercatorLon)
    {
    ...
    static function outOfChina($lat, $lon)
    {
    ...
    static function transformLat($x, $y)
    {
    ...
    static function transformLon($x, $y)
    {
    ...
    *
    */
    static function wgs2bd($lat, $lng)
    {
        list($lat, $lng) = array_values(self::gcj_encrypt($lat, $lng));
        return self::bd_encrypt($lat, $lng);
    }
