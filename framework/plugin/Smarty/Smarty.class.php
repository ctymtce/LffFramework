...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    public function __construct($tpl_base_dir='.')
    {
        ...
        */
        $this->setTemplateDir($tpl_base_dir . DS . 'templates' . DS)
             ->setCompileDir($tpl_base_dir . DS . 'templates_c' . DS)
             ->setPluginsDir(SMARTY_PLUGINS_DIR)
             ->setCacheDir($tpl_base_dir . DS . 'cache' . DS)
             ->setConfigDir($tpl_base_dir . DS . 'configs' . DS);
