...
class PDF_Chinese extends FPDF {
    ...
    function MultiCell($w, $h, $txt='', $border=0, $ln=2, $align='', $fill=false, $link='')
    {
        $txt = iconv("UTF-8", "gbk//IGNORE", $txt);
        if($this->CurrentFont['type']=='Type0')
            $this->MBMultiCell($w,$h,$txt,$border,$ln,$align,$fill);
        else
            parent::MultiCell($w,$h,$txt,$border,$ln,$align,$fill);
    }

    function MBMultiCell($w,$h, $txt='', $border=0, $ln=2, $align='', $fill=false, $link='')
    {
